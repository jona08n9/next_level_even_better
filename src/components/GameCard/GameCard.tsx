...
export interface GameCardProps
  extends Pick<
      HTMLMotionProps<'div'>,
      'animate' | 'whileHover' | 'className' | 'onClick'
    >,
              ...
              <div className='col-start-1 row-start-1 flex flex-col w-full justify-between rounded p-2 bg-gradient-to-t from-primaryCol to-transparent z-10'>
                ...
                <div className='flex flex-col justify-end'>
                  ...
                  <div className='w-full h-full'>
                    <h2 className='mt-0 md:truncate md:max-w-[15ch] text-2xl not-italic'>
                      {Name}
                    </h2>
                    <motion.div
                      initial='default'
            ...
            <DialogContent className='w-5/6 grid h-5/6 lg:max-h-[600px] overflow-y-scroll max-w-[800px] p-0'>
              ...
              <div className='px-4 flex flex-col gap-3'>
                ...
                <p
                  dangerouslySetInnerHTML={{
                    __html: (
                      ((Description as string)?.split('Español')[0] || '') +
                      '</p>'
                    ).replace(/\n/g, '<br />'),
                  }}
                />
              ...
              <div className='p-4 flex items-end h-full'>
                <p className='mt-0 uppercase'>
                  Tags:{' '}
                  <span className='text-accentCol'>{Tags?.join(', ')}</span>
                </p>
              </div>
            </DialogContent>
          )}
